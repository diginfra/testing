...
var DiginfraRules = run.NewLocalFileAccessor(
	"diginfra_rules.yaml",
	"/etc/diginfra/diginfra_rules.yaml",
)
...
var DiginfraRulesWarnings = run.NewStringFileAccessor(
	"diginfra_rules_warnings.yaml",
	`
- rule: no_warnings
