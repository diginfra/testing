...
// "tests/data" is always generated before "tests/diginfra", "tests/diginfractl", etc,
...
func DownloadAndListDiginfraCodeFiles() ([]string, error) {
	...
	err := Download(DiginfraCodeURL, DownloadDir+"/"+DiginfraCodeDir+".zip")
	if err != nil {
		return nil, err
	}
	err = Unzip(DownloadDir+"/"+DiginfraCodeDir+".zip", extractDir)
	if err != nil {
		return nil, err
	}
	return ListDirFiles(extractDir+"/"+DiginfraCodeDir+"/", true)
}
