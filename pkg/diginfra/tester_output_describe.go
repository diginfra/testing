...
// RulesetDescription represent the description of the knowledge of the Diginfra
...
// RulesetDescription converts the output of the Diginfra run into a an struct
// describing the knowledge of the Diginfra engine after loading one or more rules files.
// This is achieved with the Diginfra `-L` option combined with the JSON output enabled.
// Returns nil if Diginfra wasn't run for rules descriptions.
