...
// in a Diginfra configuration file (i.e. diginfra.yaml). InitConfig can
...
// NewPluginConfig helps creating valid Diginfra configuration files
// (i.e. diginfra.yaml) loading one or more plugins.
