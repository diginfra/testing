...
// the validation of a Diginfra rules file.
...
// RuleValidationResult represents the validation result of a Diginfra rules file.
...
// RuleValidation represents a list of validation results of Diginfra rules files.
type RuleValidation struct {
	Results []*RuleValidationResult `json:"diginfra_load_results"`
}

// RuleValidation converts the output of the Diginfra run into a list of
// validation results of Diginfra rules files. Returns nil if Diginfra wasn't run
...
// AllWarnings returns the merged list of warnings from all the validated Diginfra rules files.
...
// AllErrors returns the merged list of errors from all the validated Diginfra rules files.
