...
// Alert represent an alert produced by a Diginfra rule.
type Alert struct {
...
// Detections represents a list of Diginfra alerts.
type Detections []*Alert

// Detections converts the output of the Diginfra run into a list of rule detections.
// Returns nil if Diginfra wasn't run for rules detection.
